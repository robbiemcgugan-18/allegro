...
from allegro.models import Event, PartFormat, Music, Request, UserProfile
from django.contrib.auth.models import User
from django.core import serializers
from allegro.forms import AddMusicForm, RequestForm, UserForm, UserProfileForm, EditUserForm, UserPasswordChangeForm
import json
...
def index(request):
    ...
    return render(request, 'allegro/index.html', context_dict)
...
def user_login(request):
    ...
    if request.user.is_authenticated:
        ...
        return render(request, 'allegro/login.html', context=context_dict)
...
def menu(request):
    ...
    if user_profile.default_password:
        ...
        return render(request, 'allegro/landing.html', context=context_dict)
...
def request_music(request):
    ...
    if request.GET.get('action') == 'get':
        ...
        if piece_name != "":
            ...
            return render(request, 'allegro/part_dropdown_options.html', {'part_format_list': part_format_list})

    context_dict['form'] = form

    return render(request, 'allegro/request_music.html', context=context_dict)

@login_required
def permission_denied(request):
    return render(request, 'allegro/permission_denied.html')
...
def calendar(request):
    ...
    return render(request, 'allegro/calendar.html', context=context_dict)
...
def manage_calendar(request):
    ...
    return render(request, 'allegro/manage_calendar.html', context=context_dict)
...
def add_music(request):
    ...
    context_dict['form'] = form
    return render(request, 'allegro/add_music.html', context=context_dict)
...
def view_requests(request):
    ...
    return render(request, 'allegro/view_requests.html', context=context_dict)
...
def my_requests(request):
    ...
    return render(request, 'allegro/my_requests.html', context=context_dict)
...
def add_user(request):
    ...
    return render(request, 'allegro/add_user.html', context=context_dict)
...
def view_users(request):
    ...
    return render(request, 'allegro/view_users.html', context=context_dict)
...
def edit_user(request, user_slug):
    ...
    return render(request, 'allegro/edit_user.html', context=context_dict)
...
def change_password(request):
    ...
    return render(request, 'allegro/change_password.html', context=context_dict)
